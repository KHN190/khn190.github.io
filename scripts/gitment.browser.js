  ...
  _createClass(Gitment, [{
    ...
    value: function useTheme() {
      ...
      renderers.forEach(function (renderer) {
        return extendRenderer(_this2, renderer);
      });
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      return Promise.all([this.loadMeta(), this.loadUserInfo()]).then(function () {
        return Promise.all([_this3.loadComments().then(function () {
          return _this3.loadCommentReactions();
        }), _this3.loadReactions()]);
      }).catch(function (e) {
    ...
    value: function post(body) {
      ...
      return this.getIssue().then(function (issue) {
        ...
        _this5.state.meta.comments++;
        var pageCount = Math.ceil(_this5.state.meta.comments / _this5.perPage);
        if (_this5.state.currentPage === pageCount) {
          _this5.state.comments.push(data);
        }
        return data;
      });
    }
